...
class VGG16Model:
    ...
    def __init__(self):
        self.model = tf.keras.models.load_model('notebooks/egor_grishkov/model_vgg16.keras')

    def predict(self, image_path):
        # Использование модели для предсказания класса изображения
        predictions = self.model.predict(VGG16Model.__preprocess_image(image_path))
